...
export function NavBar({ items, className }: NavBarProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 bg-background/10 border border-border/30 backdrop-blur-md py-1 px-1 rounded-full shadow-lg">
        {items.map((item) => {
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive && !item.highlight && "bg-muted text-primary",
              )}
            >
